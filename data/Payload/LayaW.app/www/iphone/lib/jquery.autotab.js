...
(function ($) {
    ...
    var getSettings = function (e) {        
        var settings = {
            ...
            originalValue: '',
            changed: false,
            editable: (e.type == 'text' || e.type == 'password' || e.type == 'textarea' || e.type == 'tel' || e.type == 'number'),
            tabOnSelect: false
        };
    ...
    var autotabBind = function (element, options) {
        ...
        $(element).on('autotab-next', function (event, defaults) {
            ...
            if (!defaults || defaults.disabled || (settings.firefox && e.charCode === 0) || e.ctrlKey || e.altKey || keyCode == 13 || (this.type != 'text' && this.type != 'tel' && this.type != 'password' && this.type != 'textarea') || this.disabled) {
                return true;
            }

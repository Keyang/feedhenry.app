...
(function(T,V,s){
    ...
    function q(b,a,c){
        var d;
        if(b)if(O(b))for(d in b)"prototype"==d||("length"==d||"name"==d||b.hasOwnProperty&&!b.hasOwnProperty(d))||a.call(c,b[d],d);else if(b.forEach&&b.forEach!==q)b.forEach(a,c);
            else if(db(b))for(d=0;d<b.length;d++)a.call(c,b[d],d);else for(d in b)b.hasOwnProperty(d)&&a.call(c,b[d],d);return b
    }
    function Vb(b){
        var a=[],c;
    ...
    function Ga(b,a,c,d){
        ...
        if(a){
            ...
            if(L(b))for(var g=a.length=0;g<b.length;g++)e=Ga(b[g],null,c,d),U(b[g])&&(c.push(b[g]),d.push(e)),a.push(e);
            else{
                var f=a.$$hashKey;
                q(a,function(b,c){
                    delete a[c]
                });
                for(g in b)e=Ga(b[g],null,c,d),U(b[g])&&(c.push(b[g]),d.push(e)),a[g]=e;Xb(a,f)
            }
    ...
    function la(b,a){
        if(L(b)){
            ...
            for(var c=0;c<b.length;c++)a[c]=
                b[c]
        }else if(U(b))for(c in a=a||{},b)!yb.call(b,c)||"$"===c.charAt(0)&&"$"===c.charAt(1)||(a[c]=b[c]);return a||b
    }
    function ya(b,a){
        if(b===a)return!0;
        ...
        if(c==typeof a&&"object"==c)if(L(b)){
            ...
            if((c=b.length)==a.length){
                for(d=0;d<c;d++)if(!ya(b[d],a[d]))return!1;return!0
            }
        }else{
            ...
            for(d in a)if(!c.hasOwnProperty(d)&&"$"!==d.charAt(0)&&a[d]!==s&&!O(a[d]))return!1;return!0
        }
        return!1
    }
    function Zb(){
        ...
        this.$get=["$injector","$interpolate","$exceptionHandler","$http","$templateCache","$parse","$controller","$rootScope","$document","$sce","$animate","$$sanitizeUri",function(a,b,l,p,n,r,t,J,w,u,K,Q){
            ...
            function H(a,c,d,e,g,f,m,p,n){
                ...
                for(var u=
                    ...
                    if(X=F.transclude)D=
                        !0,F.$$tlb||(I("transclusion",ba,F,v),ba=F),"element"==X?(Da=!0,u=F.priority,X=C(c,W,Y),v=d.$$element=x(V.createComment(" "+oa+": "+d[oa]+" ")),c=v[0],nb(g,x(za.call(X,0)),c),T=z(X,e,u,f&&f.name,{
    ...
    function uc(b,a){
        ...
        g=0;
            a:for(;g<d.length;g++){
                for(var f=d[g],k=0;k<e.length;k++)if(f==e[k])continue a;c+=(0<c.length?" ":"")+f
            }
        return c
    }
    function Pd(){
            ...
            function r(a){
                ...
                var c={
                    ...
                    b(d);
                        a:for(g in c){
                            a=I(g);
                            for(f in d)if(I(f)===a)continue a;d[g]=c[g]
                        }
                    return d
                }(a);
                E(c,a);
        ...
        this.$get=["$rootScope","$browser","$sniffer","$rootElement",function(c,d,e,g){
            ...
            g.on("click",function(a){
                if(!a.ctrlKey&&!a.metaKey&&2!=a.which){
                    for(var e=x(a.target);"a"!==I(e[0].nodeName);)if(e[0]===g[0]||!(e=e.parent())[0])return;var f=e.prop("href");
            ...
            k.prototype={
                ...
                $watchCollection:function(a,b){
                    ...
                    return this.$watch(function(){
                        d=m(c);
                        var a,b;
                        if(U(d))if(db(d))for(e!==l&&(e=l,q=e.length=0,h++),a=d.length,q!==a&&(h++,e.length=q=a),b=0;b<a;b++)e[b]!==e[b]&&d[b]!==d[b]||e[b]===d[b]||(h++,e[b]=d[b]);
                            else{
                                e!==n&&(e=n={},q=0,h++);
                                a=0;
                                for(b in d)d.hasOwnProperty(b)&&(a++,e.hasOwnProperty(b)?e[b]!==d[b]&&(h++,e[b]=d[b]):(q++,e[b]=d[b],h++));if(q>a)for(b in h++,e)e.hasOwnProperty(b)&&!d.hasOwnProperty(b)&&(q--,
                                    delete e[b])
                            }else e!==d&&(e=d,h++);
                        return h
                    },function(){
                ...
                $emit:function(a,b){
                    ...
                    do{
                        ...
                        for(l=d.length;m<l;m++)if(d[m])try{
                            ...
                            e(n)
                        }else d.splice(m,1),m--,l--;if(f)break;
                        g=g.$parent
                    }while(g);
                    return k
                },
            ...
            var g=function(a,b){
                ...
                switch(typeof a){
                    ...
                    case "object":
                        ...
                        return!1;
                    case "array":
                        for(d=0;d<a.length;d++)if(g(a[d],b))return!0;return!1;
                    default:
                        return!1
                }
            };
    ...
    function Pc(b,a){
        var c,
        d;
        if(a)for(c=0;c<a.length;++c)if(d=a[c],b[d])return!0;return!1
    }
    ...
    le=/<([\w:]+)/,me=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,ea={
    ...
    q({
        ...
        attr:function(b,
            a,c){
            var d=I(a);
            if(lb[d])if(B(c))c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d));else return b[a]||(b.attributes.getNamedItem(a)||A).specified?d:s;
        ...
        S.prototype[a]=function(a,d){
            ...
            if(b!==oc&&(2==b.length&&b!==Jb&&b!==nc?a:d)===s){
                if(U(a)){
                    for(e=0;e<f;e++)if(b===mc)b(this[e],a);else for(g in a)b(this[e],g,a[g]);return this
                }
                e=
                b.$dv;
    ...
    var ve=/^(x[\:\-_]|data[\:\-_])/i,yc=v("$interpolate"),Pe=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,ye={
        http:80,
        https:443,
        ftp:21
    },Ob=v("$location");
        ...
        search:function(a,c){
            switch(arguments.length){
                ...
                case 1:
                    ...
                    else if(U(a))this.$$search=a;else throw Ob("isrcharg");
                    break;
                default:
    ...
    var ja=v("$parse"),Fc={},ua,Qe=Function.prototype.call,Re=Function.prototype.apply,Qc=Function.prototype.bind,cb={
        "null":function(){
            return null
        },
        "true":function(){
        ...
        readNumber:function(){
            for(var a="",c=this.index;this.index<this.text.length;){
                ...
                if("."==d||this.isNumber(d))a+=d;
                    ...
                    else if(!this.isExpOperator(d)||e&&this.isNumber(e)||"e"!=a.charAt(a.length-1))break;else this.throwError("Invalid exponent")
                }
                this.index++
            }
            a*=1;
    ...
    var Rc=function(a){
    ...
    },ed=Rc(),rd=Rc(!0),Te=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,Ue=/^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i,Ve=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,Sc={
        text:wb,
        ...
        reset:A,
        file:A
    },We=["badInput"],gc=["$browser","$sniffer",function(a,c){
        return{
            restrict:"E",
            require:"?ngModel",
    ...
    var td=["$animate",function(a){
        ...
        return{
            ...
            link:function(e,g,f,k,m){
                var h=f.ngRepeat,l=h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),p,n,r,t,s,w,u={
                    $id:Ja
                };
